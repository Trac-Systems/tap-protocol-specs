...
- from block 941848 onwards, miner reward addresses have blocked token-transfer and they need to use "unblock-transferables" to unlock. token-send and token-trade stay disabled. Token auth (redeem) working without change. 
